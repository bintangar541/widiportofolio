...
<title>Penyewaan Sepada Motor</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Temukan Motor Sempurna Anda</h1>
            <p>Kami memiliki lebih dari seribu sepeda motor untuk Anda pilih.</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Temukan yang Terbaik<span>Sepeda motor Untuk Anda</span></h2>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Kami Puas <span> Review Customer</span></h2>
    </div>
    <div class="row">
